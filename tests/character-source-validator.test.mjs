...
test('character source validator explicitly covers the critical failure classes',()=>{
  ...
  for(const marker of ['requiredGroups','duplicate id','embedded raster','unknown color','anchor ref','product alias leakage','compose-characters.mjs','generate-character-icons.mjs']){
